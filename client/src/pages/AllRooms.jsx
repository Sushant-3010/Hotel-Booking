...
const AllRooms = () => {
    ...
    // function for HAnddel changes for filter 
            ...
            <div className='md:w-1/2 flex flex-col gap-2'>
              ...
              <div className='flex items-center gap-4 mt-3 mb-6 flex-wrap'>
                {room.amenities.map((item, index) => (
                  <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF]/70 hover:bg-blue-200 transition-all duration-300 ease-in-out'>
