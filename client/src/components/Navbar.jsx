...
const Navbar = () => {
    ...
    return (         
                ...
                <div className="hidden md:flex items-center gap-4 lg:gap-8">
                    ...
                    <button className={`border px-4 py-1 text-sm font-light rounded-full cursor-pointer text-lg font-semibold  ${isScrolled ? 'text-black' : 'text-white'} transition-all`}onClick={() =>  navigate('/owner')}>
                        Dashboard 
                    </button>
                </div>
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    :
                    ( <button onClick={openSignIn} className="bg-black text-white px-8 py-2.5 rounded-full ml-4 transition-all duration-500 text-lg font-semibold " >
                        Login
                    </button>)
                    }
